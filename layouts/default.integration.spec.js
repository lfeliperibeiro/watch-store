...
describe('Default Layout', () => {
  ...
  afterEach(() => {
    ...
    it('should set email header on Axios when Cart emits checkout event', async () => {
  ...
  it('should call Axios.post with the rigth endpoint and send products', async () => {
  ...
  it('should display error notice when Axios.post fails,', async () => {
    ...
    const cartComponent = wrapper.findComponent(Cart).vm;
    await cartComponent.$emit('checkout', {email: 'email@email.com'})
    await flushPromises();
